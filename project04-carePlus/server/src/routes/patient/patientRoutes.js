...
import { bookAppointment, getAppointmentsList, cancelAppointment, rescheduleAppointment } from "../../controllers/patient/appointmentControllers.js";
...
import { getNotificationsList, markNotificationAsRead } from "../../controllers/patient/notificationControllers.js";
...
router.post('/appointments/reschedule', verifyJWT("patient"), rescheduleAppointment);
...
router.get('/medical-records/list', verifyJWT("patient"), getMedicalRecordsList);

// NOTIFICATIONS ROUTES
router.get('/notifications/list', verifyJWT("patient"), getNotificationsList)
router.post('/notifications/mark-as-read', verifyJWT("patient"), markNotificationAsRead)

// DOCTOR ROUTES
router.get('/doctors/profile/get/:doctorId', verifyJWT("patient"), getDoctorProfile)
